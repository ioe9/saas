<?php
class Varien_Validate_Hostname extends Varien_Validate_Abstract
{
    ...
    /**
     * @param Varien_Validate_Ip $ipValidator OPTIONAL
     * @return Varien_Validate_Hostname
     */
    public function setIpValidator(Varien_Validate_Ip $ipValidator = null)
    {
        if ($ipValidator === null) {
            $ipValidator = new Varien_Validate_Ip();
        }
     ...
     *
     * @param  integer $allow
     * @return Varien_Validate_Hostname Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @throws Varien_Validate_Exception if a fatal error occurs for validation process
     * @return boolean
     */
    public function isValid($value)
    {
		...
		$pattern = "/^([0-9a-z]+\\.[a-z]{2,3}(\\.[a-z]{2})?)$/i";
