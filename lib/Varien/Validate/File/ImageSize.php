 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_File_ImageSize extends Varien_Validate_Abstract
{
    /**
     ...
     * @throws Varien_Validate_Exception
     */
    public function __construct($options)
    {
        if ($options instanceof Zend_Config) {
            ...
            throw new Varien_Validate_Exception ('Invalid options to validator provided');
        }
     ...
     * @throws Varien_Validate_Exception      When minwidth is greater than maxwidth
     * @throws Varien_Validate_Exception      When minheight is greater than maxheight
     * @return Varien_Validate_File_ImageSize Provides a fluent interface
     */
    public function setImageMin($options)
    {
        if (isset($options['minwidth'])) {
            if (($this->_maxwidth !== null) and ($options['minwidth'] > $this->_maxwidth)) {
                #require_once 'Zend/Validate/Exception.php';
                throw new Varien_Validate_Exception("The minimum image width must be less than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_maxheight !== null) and ($options['minheight'] > $this->_maxheight)) {
                #require_once 'Zend/Validate/Exception.php';
                throw new Varien_Validate_Exception("The minimum image height must be less than or equal to the "
     ...
     * @throws Varien_Validate_Exception When maxwidth is smaller than minwidth
     * @throws Varien_Validate_Exception When maxheight is smaller than minheight
     * @return Varien_Validate_StringLength Provides a fluent interface
     */
    public function setImageMax($options)
    {
        if (isset($options['maxwidth'])) {
            if (($this->_minwidth !== null) and ($options['maxwidth'] < $this->_minwidth)) {
                #require_once 'Zend/Validate/Exception.php';
                throw new Varien_Validate_Exception("The maximum image width must be greater than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_minheight !== null) and ($options['maxheight'] < $this->_minheight)) {
                #require_once 'Zend/Validate/Exception.php';
                throw new Varien_Validate_Exception("The maximum image height must be greater than or equal to the "
    ...
    /**
     * Defined by Varien_Validate_Interface
     *
