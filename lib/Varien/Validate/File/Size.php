 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_File_Size extends Varien_Validate_Abstract
{
    /**#@+
     ...
     * @throws Varien_Validate_Exception When min is greater than max
     * @return Varien_Validate_File_Size Provides a fluent interface
     */
    public function setMin($min)
    {
        ...
        if (($max !== null) && ($min > $max)) {
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception("The minimum must be less than or equal to the maximum filesize, but $min >"
                                            . " $max");
        }
     ...
     * @throws Varien_Validate_Exception When max is smaller than min
    ...
    public function setMax($max)
    {
        ...
        if (($min !== null) && ($max < $min)) {
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception("The maximum must be greater than or equal to the minimum filesize, but "
                                            . "$max < $min");
        }
     ...
     *
     * @param  int $size
     * @return Varien_Validate_File_Size
     */
