 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_File_Hash extends Varien_Validate_Abstract
{
    /**
     ...
     *
     * @param  string|array $options
     * @return Varien_Validate_File_Hash Provides a fluent interface
     */
    ...
    public function addHash($options)
    {
        if (is_string($options)) {
            ...
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception("False parameter given");
        }
        ...
        if (!in_array($algorithm, $known)) {
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception("Unknown algorithm '{$algorithm}'");
        }
