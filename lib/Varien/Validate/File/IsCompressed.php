...
/**
 * @see Varien_Validate_File_MimeType
 */
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_File_IsCompressed extends Varien_Validate_File_MimeType
{
    /**
    ...
    protected function _throw($file, $errorType)
    {
        ...
        switch($errorType) {
            case Varien_Validate_File_MimeType::FALSE_TYPE :
                $errorType = self::FALSE_TYPE;
                break;
            case Varien_Validate_File_MimeType::NOT_DETECTED :
                $errorType = self::NOT_DETECTED;
                break;
            case Varien_Validate_File_MimeType::NOT_READABLE :
