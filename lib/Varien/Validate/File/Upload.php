 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_File_Upload extends Varien_Validate_Abstract
{
    /**@#+
     ...
     * @return array
     * @throws Varien_Validate_Exception If file is not found
     */
    public function getFiles($file = null)
    {
        if ($file !== null) {
            ...
            if (count($return) === 0) {
                ...
                throw new Varien_Validate_Exception("The file '$file' was not found");
            }
     ...
     * @return Varien_Validate_File_Upload Provides a fluent interface
     */
