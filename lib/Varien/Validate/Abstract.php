 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Varien_Validate_Abstract implements Varien_Validate_Interface
{
    /**
    ...
    public function setMessage($messageString, $messageKey = null)
    {
        ...
        if (!isset($this->_messageTemplates[$messageKey])) {
            ...
            throw new Varien_Validate_Exception("No message template exists for key '$messageKey'");
        }
     ...
     * @return Varien_Validate_Abstract
     */
    ...
    public function __get($property)
    {
         ...
         */
        #require_once 'Zend/Validate/Exception.php';
        throw new Varien_Validate_Exception("No property exists by the name '$property'");
    }
