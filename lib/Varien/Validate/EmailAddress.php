<?php
class Varien_Validate_EmailAddress extends Varien_Validate_Abstract
{
    ...
    protected $_options = array(
        ...
        'deep'     => false,
        'domain'   => true,
        'allow'    => Varien_Validate_Hostname::ALLOW_DNS,
        'hostname' => null
    );
     ...
     * 'hostname' => A hostname validator, see Varien_Validate_Hostname
     * 'allow'    => Options for the hostname validator, see Varien_Validate_Hostname::ALLOW_*
     ...
     *
     * @param array $options
     * @return Varien_Validate_EmailAddress Provides a fluent inteface
     */
     ...
     * @return Varien_Validate_Abstract Provides a fluent interface
     ...
     *
     * @return Varien_Validate_Hostname
     */
    ...
    /**
     * @param Varien_Validate_Hostname $hostnameValidator OPTIONAL
     * @param int                    $allow             OPTIONAL
     * @return $this
     */
    public function setHostnameValidator(Varien_Validate_Hostname $hostnameValidator = null, $allow = Varien_Validate_Hostname::ALLOW_DNS)
    {
        if (!$hostnameValidator) {
            $hostnameValidator = new Varien_Validate_Hostname($allow);
        }
    ...
    public function setValidateMx($mx)
    {
        if ((bool) $mx && !$this->validateMxSupported()) {
            ...
            throw new Varien_Validate_Exception('MX checking not available on this system');
        }
