 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_InArray extends Varien_Validate_Abstract
{
    ...
    public function __construct($options)
    {
        if ($options instanceof Zend_Config) {
            ...
            throw new Varien_Validate_Exception('Array expected as parameter');
        } else {
            $count = func_num_args();
            $temp  = array();
            if ($count > 1) {
     ...
     * @return Varien_Validate_InArray Provides a fluent interface
     */
