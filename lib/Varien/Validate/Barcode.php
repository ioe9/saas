 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_Barcode extends Varien_Validate_Abstract
{
     ...
     * Barcode adapter
     *
     * @var Varien_Validate_Barcode_BarcodeAdapter
     */
    protected $_adapter;
     ...
     *         Varien_Validate_Barcode_BarcodeAdapter $adapter Barcode adapter to use
    ...
    public function __construct($adapter)
    {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                throw new Varien_Validate_Exception("Missing option 'adapter'");
            }
        }
     ...
     *
     * @return Varien_Validate_Barcode_BarcodeAdapter
     */
     ...
     *
     * @param  string|Varien_Validate_Barcode $adapter Barcode adapter to use
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        if (Zend_Loader::isReadable('Zend/Validate/Barcode/' . $adapter. '.php')) {
            $adapter = 'Varien_Validate_Barcode_' . $adapter;
        }
        ...
        if (!$this->_adapter instanceof Varien_Validate_Barcode_AdapterInterface) {
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception(
                "Adapter " . $adapter . " does not implement Varien_Validate_Barcode_AdapterInterface"
            );
        }
     ...
     * @return Varien_Validate_Barcode
     */
