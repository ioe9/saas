 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Validate_Callback extends Varien_Validate_Abstract
{
    /**
     * Invalid callback
     */
    ...
    public function __construct($callback = null)
    {
        ...
        if (null === ($initializedCallack = $this->getCallback())) {
            ...
            throw new Varien_Validate_Exception('No callback registered');
        }
    }
     ...
     * @throws Varien_Validate_Exception
     * @return Varien_Validate_Callback Provides a fluent interface
     */
    public function setCallback($callback)
    {
        if (!is_callable($callback)) {
            #require_once 'Zend/Validate/Exception.php';
            throw new Varien_Validate_Exception('Invalid callback given');
        }
