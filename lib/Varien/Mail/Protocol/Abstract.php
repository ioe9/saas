...
/**
 * @see Varien_Validate_Hostname
 */
#require_once 'Zend/Validate/Hostname.php';


/**
 * Varien_Mail_Protocol_Abstract
 *
 ...
 */
abstract class Varien_Mail_Protocol_Abstract
{
    /**
    ...
    /**
     * Instance of Varien_Validate to check hostnames
     * @var Varien_Validate
     */
    ...
    protected function _connect($remote)
    {
        ...
        if ($this->_socket === false) {
            ...
            echo $errorStr;
            throw new Varien_Mail_Protocol_Exception($errorStr);
        }
        ...
        if (($result = $this->_setStreamTimeout(self::TIMEOUT_CONNECTION)) === false) {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception('Could not set stream timeout');
        }
    ...
    protected function _send($request)
    {
        if (!is_resource($this->_socket)) {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception('No connection has been established to ' . $this->_host);
        }
        ...
        if ($result === false) {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception('Could not send request to ' . $this->_host);
        }
    ...
    protected function _receive($timeout = null)
    {
        ...
        if (!empty($info['timed_out'])) {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception($this->_host . ' has timed out');
        }
        ...
        if ($reponse === false) {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception('Could not read from ' . $this->_host);
        }
     ...
     * Throws a Varien_Mail_Protocol_Exception if an unexpected code is returned.
     *
    ...
    protected function _expect($code, $timeout = null)
    {
        ...
        if ($errMsg !== '') {
             ...
             */
            #require_once 'Zend/Mail/Protocol/Exception.php';
            throw new Varien_Mail_Protocol_Exception($errMsg, $cmd);
        }
