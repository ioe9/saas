 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Transport_File extends Varien_Mail_Transport_Abstract
{
    /**
     ...
     * Constructor
     *
     * @param  array|Varien_Config $options OPTIONAL (Default: null)
     * @return void
     */
     ...
     *
     * @return void
     * @throws Varien_Mail_Transport_Exception on not writable target directory
     * @throws Varien_Mail_Transport_Exception on file_put_contents() failure
     */
    protected function _sendMail()
    {
        ...
        if (!is_writable(dirname($file))) {
            ...
            throw new Varien_Mail_Transport_Exception(sprintf(
        ...
        if (!file_put_contents($file, $email)) {
            #require_once 'Zend/Mail/Transport/Exception.php';
            throw new Varien_Mail_Transport_Exception('Unable to send mail');
        }
    }
     ...
     *
     * @param Varien_Mail_Transport_File File transport instance
     * @return string
     */
