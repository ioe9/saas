 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Transport_Sendmail extends Varien_Mail_Transport_Abstract
{
    /**
     * Subject
     * @var string
     ...
     * Constructor.
     *
     * @param  string|array|Varien_Config $parameters OPTIONAL (Default: null)
     * @return void
     */
    public function __construct($parameters = null)
    {
        if ($parameters instanceof Varien_Config) {
     ...
     * @access public
     * @return void
     * @throws Varien_Mail_Transport_Exception if parameters is set
     *         but not a string
     * @throws Varien_Mail_Transport_Exception on mail() failure
     */
    public function _sendMail()
    {
        if ($this->parameters === null) {
            ...
            if(!is_string($this->parameters)) {
                ...
                throw new Varien_Mail_Transport_Exception(
        ...
        if ($this->_errstr !== null || !$result) {
             ...
             */
            #require_once 'Zend/Mail/Transport/Exception.php';
            throw new Varien_Mail_Transport_Exception('Unable to send mail. ' . $this->_errstr);
        }
    }
     ...
     * @param   array $headers
     * @return  void
     * @throws  Varien_Mail_Transport_Exception
     */
    protected function _prepareHeaders($headers)
    {
        ...
        if (0 === strpos(PHP_OS, 'WIN')) {
            ...
            if (empty($this->recipients)) {
                 ...
                 */
                #require_once 'Zend/Mail/Transport/Exception.php';
                throw new Varien_Mail_Transport_Exception('Missing To addresses');
            }
        } else {
            ...
            if (!isset($headers['To'])) {
                 ...
                 */
                #require_once 'Zend/Mail/Transport/Exception.php';
                throw new Varien_Mail_Transport_Exception('Missing To header');
            }
