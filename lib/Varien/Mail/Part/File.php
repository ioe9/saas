 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Part_File extends Varien_Mail_Part
{
    ...
    public function __construct(array $params)
    {
        if (empty($params['file'])) {
            ...
            throw new Varien_Mail_Exception('no file given in params');
        }
        ...
        if (!$this->_fh) {
             ...
             */
            #require_once 'Zend/Mail/Exception.php';
            throw new Varien_Mail_Exception('could not open file');
        }
        ...
        Varien_Mime_Decode::splitMessage($header, $this->_headers, $null);
        ...
        while (!feof($this->_fh) && ($endPos === null || $pos < $endPos)) {
            ...
            if ($line === false) {
                 ...
                 */
                #require_once 'Zend/Mail/Exception.php';
                throw new Varien_Mail_Exception('error reading file');
            }
