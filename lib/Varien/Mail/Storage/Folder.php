 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Storage_Folder implements RecursiveIterator
{
    /**
     * subfolders of folder array(localName => Varien_Mail_Storage_Folder folder)
     * @var array
     */
    protected $_folders;
     ...
     * @param array  $folders    init with given instances of Varien_Mail_Storage_Folder as subfolders
     */
    ...
    public function hasChildren()
    {
        ...
        return $current && $current instanceof Varien_Mail_Storage_Folder && !$current->isLeaf();
    }

    /**
     * implements RecursiveIterator::getChildren()
     *
     * @return Varien_Mail_Storage_Folder same as self::current()
     */
     ...
     *
     * @return Varien_Mail_Storage_Folder current folder
     */
     ...
     * @return Varien_Mail_Storage_Folder folder named $folder
    ...
    public function __get($name)
    {
        if (!isset($this->_folders[$name])) {
            ...
            throw new Varien_Mail_Storage_Exception("no subfolder named $name");
        }
     ...
     * @param Varien_Mail_Storage_Folder $folder instance for new subfolder
     * @return null
     */
    public function __set($name, Varien_Mail_Storage_Folder $folder)
    {
