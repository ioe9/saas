 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Storage_Maildir extends Varien_Mail_Storage_Abstract
{
    /**
     * used message class, change it in an extened class to extend the returned message class
     * @var string
     */
    protected $_messageClass = 'Varien_Mail_Message_File';
     ...
     * @var array
     */
    protected static $_knownFlags = array('D' => Varien_Mail_Storage::FLAG_DRAFT,
                                          'F' => Varien_Mail_Storage::FLAG_FLAGGED,
                                          'P' => Varien_Mail_Storage::FLAG_PASSED,
                                          'R' => Varien_Mail_Storage::FLAG_ANSWERED,
                                          'S' => Varien_Mail_Storage::FLAG_SEEN,
                                          'T' => Varien_Mail_Storage::FLAG_DELETED);
    ...
    protected function _getFileData($id, $field = null)
    {
        if (!isset($this->_files[$id - 1])) {
            ...
            throw new Varien_Mail_Storage_Exception('id does not exist');
        }
        ...
        if (!isset($this->_files[$id - 1][$field])) {
             ...
             */
            #require_once 'Zend/Mail/Storage/Exception.php';
            throw new Varien_Mail_Storage_Exception('field does not exist');
        }
     ...
     * @return Varien_Mail_Message_File
     * @throws Varien_Mail_Storage_Exception
     */
    ...
    public function __construct($params)
    {
        ...
        if (!$this->_isMaildir($params->dirname)) {
             ...
             */
            #require_once 'Zend/Mail/Storage/Exception.php';
            throw new Varien_Mail_Storage_Exception('invalid maildir given');
        }
    ...
    protected function _openMaildir($dirname)
    {
        ...
        if (!$dh) {
             ...
             */
            #require_once 'Zend/Mail/Storage/Exception.php';
            throw new Varien_Mail_Storage_Exception('cannot open maildir');
        }
        ...
        if ($dh) {
            $this->_getMaildirFiles($dh, $dirname . '/new/', array(Varien_Mail_Storage::FLAG_RECENT));
            closedir($dh);
             ...
             */
            #require_once 'Zend/Mail/Storage/Exception.php';
            throw new Varien_Mail_Storage_Exception('cannot read recent mails in maildir');
        }
    }
    ...
    public function removeMessage($id)
    {
         ...
         */
        #require_once 'Zend/Mail/Storage/Exception.php';
        throw new Varien_Mail_Storage_Exception('maildir is (currently) read-only');
    }
