 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Varien_Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator
{
    /**
     ...
     * @var string
     */
    protected $_messageClass = 'Varien_Mail_Message';
    ...
    public function __get($var)
    {
        ...
        throw new Varien_Mail_Storage_Exception($var . ' not found');
    }
     ...
     */
      ...
      *
      * @param    int $id
      * @return   Varien_Mail_Message message object
      */
     ...
     public function offsetSet($id, $value)
     {
         ...
         */
        #require_once 'Zend/Mail/Storage/Exception.php';
        throw new Varien_Mail_Storage_Exception('cannot write mail messages via array access');
     }
      ...
      * Iterator::current()
      *
      * @return   Varien_Mail_Message current message
      */
