 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Mail_Storage_Pop3 extends Varien_Mail_Storage_Abstract
{
    /**
     * protocol handler
     * @var null|Varien_Mail_Protocol_Pop3
     */
    protected $_protocol;
    ...
    public function getRawContent($id, $part = null)
    {
        ...
        Varien_Mime_Decode::splitMessage($content, $null, $body);
        return $body;
    }
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof Varien_Mail_Protocol_Pop3) {
        ...
        $this->_protocol = new Varien_Mail_Protocol_Pop3();
     ...
     *
     * @see Varien_Mail_Storage_Abstract:__get()
     * @param  string $var
     * @return string
     * @throws Varien_Mail_Storage_Exception
     */
