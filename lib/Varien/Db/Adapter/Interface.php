 ...
 * DISCLAIMER
 *
 * Do not edit or add to this file if you wish to upgrade Mio to newer
 * versions in the future. If you wish to customize Mio for your
 ...
 * @category    Varien
 * @package     Varien_Db
 * @author      Mio Core Team <core@magentocommerce.com>
 */
interface Varien_Db_Adapter_Interface
{
     ...
     *                      May be a string or Magento_Db_Select.
     ...
     *
     * @param string|Magento_Db_Select $sql  An SQL SELECT statement.
     ...
     *
     * @param string|array|Magento_Db_Expr $ident The identifier or expression.
