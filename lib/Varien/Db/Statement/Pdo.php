<?php
class Varien_Db_Statement_Pdo extends Varien_Db_Statement implements IteratorAggregate
{
    ...
    protected function _prepare($sql)
    {
        try {
            ...
            throw new Varien_Db_Exception($e->getMessage(), $e->getCode(), $e);
        }
    }
    ...
    public function _execute(array $params = null)
    {
        try {
            ...
            throw new Varien_Db_Exception($message, (int) $e->getCode(), $e);
        }
    }
