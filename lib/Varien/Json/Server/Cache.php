...
/**
 * Varien_Json_Server_Cache: cache Varien_Json_Server server definition and SMD
 *
 * @category   Zend
 * @package    Varien_Json
 * @subpackage Server
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Json_Server_Cache extends Varien_Server_Cache
{
    /**
     ...
     * @param  Varien_Json_Server $server
     * @return boolean
     */
    public static function saveSmd($filename, Varien_Json_Server $server)
    {
