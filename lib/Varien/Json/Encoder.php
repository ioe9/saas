...
class Varien_Json_Encoder
{
     ...
     * @param object $value
     * @return string
     * @throws Varien_Json_Exception If recursive checks are enabled and the object has been serialized previously
     */
    ...
    public static function encodeClass($className, $package = '')
    {
        ...
        if (! $cls->isInstantiable()) {
            #require_once 'Zend/Json/Exception.php';
            throw new Varien_Json_Exception("$className must be instantiable");
        }
