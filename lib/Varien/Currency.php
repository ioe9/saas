...
class Varien_Currency
{
     ...
     * @param  string|Varien_Locale $locale  OPTIONAL locale name
    ...
    public function __construct($options = null, $locale = null)
    {
        ...
        } else if (Varien_Locale::isLocale($options, false, false)) {
    ...
    public function toCurrency($value = null, array $options = array())
    {
        ...
        if (empty($format)) {
            $format = Varien_Locale_Data::getContent($locale, 'currencynumber');
        } else if (Varien_Locale::isLocale($format, true, false)) {
            $locale = $format;
            $format = Varien_Locale_Data::getContent($format, 'currencynumber');
        }

        $original = $value;
        $value    = Varien_Locale_Format::toNumber($value, array('locale'        => $locale,
        ...
        if (empty($options['script']) === false) {
            $value = Varien_Locale_Format::convertNumerals($value, 'Latn', $options['script']);
        }
     ...
     * @param  string|Varien_Locale $locale   (Optional) Locale to display informations
    ...
    private function _checkParams($currency = null, $locale = null)
    {
        ...
        if ((empty($locale)) and (!empty($currency)) and
            (Varien_Locale::isLocale($currency, true, false))) {
            $locale   = $currency;
            $currency = null;
        }
        ...
        $country = null;
        if ((Varien_Locale::isLocale($locale, true, false)) and (strlen($locale) > 4)) {
        ...
        $data = Varien_Locale_Data::getContent($locale, 'currencytoregion', $country);
    ...
    public function getSymbol($currency = null, $locale = null)
    {
        ...
        // Get the symbol
        $symbol = Varien_Locale_Data::getContent($params['locale'], 'currencysymbol', $params['currency']);
        if (empty($symbol) === true) {
            $symbol = Varien_Locale_Data::getContent($params['locale'], 'currencysymbol', $params['name']);
        }
     ...
     * @param  string|Varien_Locale $locale   OPTIONAL The locale
     * @return string
     */
    public function getShortName($currency = null, $locale = null)
    {
        ...
        $list = Varien_Locale_Data::getContent($params['locale'], 'currencytoname', $params['currency']);
        if (empty($list) === true) {
            $list = Varien_Locale_Data::getContent($params['locale'], 'nametocurrency', $params['currency']);
            if (empty($list) === false) {
    ...
    public function getName($currency = null, $locale = null)
    {
        ...
        // Get the name
        $name = Varien_Locale_Data::getContent($params['locale'], 'nametocurrency', $params['currency']);
        if (empty($name) === true) {
            $name = Varien_Locale_Data::getContent($params['locale'], 'nametocurrency', $params['name']);
        }
    ...
    public function getRegionList($currency = null)
    {
        ...
        $data = Varien_Locale_Data::getContent($this->_options['locale'], 'regiontocurrency', $currency);
    ...
    public function getCurrencyList($region = null)
    {
        ...
        $data = Varien_Locale_Data::getContent($this->_options['locale'], 'currencytoregion', $region);
    ...
    {
        return Varien_Locale_Data::getCache();
    }
    ...
    {
        Varien_Locale_Data::setCache($cache);
    }
    ...
    {
        return Varien_Locale_Data::hasCache();
    }
    ...
    {
        Varien_Locale_Data::removeCache();
    }
    ...
    {
        Varien_Locale_Data::clearCache($tag);
    }
     ...
     *
     * @param  string|Varien_Locale $locale (Optional) Locale for parsing input
    ...
    public function setLocale($locale = null)
    {
        ...
        try {
            $locale = Varien_Locale::findLocale($locale);
            if (strlen($locale) > 4) {
        ...
        } catch (Varien_Locale_Exception $e) {
            #require_once 'Zend/Currency/Exception.php';
    ...
    protected function _checkOptions(array $options = array())
    {
        ...
        foreach ($options as $name => $value) {
            ...
            switch($name) {
                ...
                case 'format':
                    if ((empty($value) === false) and (Varien_Locale::isLocale($value, null, false) === false)) {
                ...
                case 'script':
                    try {
                        Varien_Locale_Format::convertNumerals(0, $options['script']);
                    } catch (Varien_Locale_Exception $e) {
                        #require_once 'Zend/Currency/Exception.php';
                        throw new Zend_Currency_Exception($e->getMessage());
                    }
