...
class Varien_Acl
{
    ...
    /**
     * @var Varien_Acl_Role_Interface
     */
    protected $_isAllowedRole     = null;

    /**
     * @var Varien_Acl_Resource_Interface
     */
     ...
     * @uses   Varien_Acl_Role_Registry::add()
     * @return Varien_Acl Provides a fluent interface
     */
    public function addRole($role, $parents = null)
    {
        if (is_string($role)) {
            $role = new Varien_Acl_Role($role);
        }

        if (!$role instanceof Varien_Acl_Role_Interface) {
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception('addRole() expects $role to be of type Varien_Acl_Role_Interface');
        }
     ...
     *
     * @param  Varien_Acl_Role_Interface|string $role
     * @uses   Varien_Acl_Role_Registry::has()
     * @return boolean
     */
     ...
     * @uses   Varien_Acl_Role_Registry::inherits()
     * @return boolean
     */
     ...
     *
     * @param  Varien_Acl_Role_Interface|string $role
     * @uses   Varien_Acl_Role_Registry::remove()
     * @return Varien_Acl Provides a fluent interface
     */
     ...
     *
     * @uses   Varien_Acl_Role_Registry::removeAll()
     * @return Varien_Acl Provides a fluent interface
     */
     ...
     *
     * @param  Varien_Acl_Resource_Interface|string $resource
     * @param  Varien_Acl_Resource_Interface|string $parent
     * @throws Varien_Acl_Exception
     * @return Varien_Acl Provides a fluent interface
     */
    public function addResource($resource, $parent = null)
    {
        if (is_string($resource)) {
            $resource = new Varien_Acl_Resource($resource);
        }

        if (!$resource instanceof Varien_Acl_Resource_Interface) {
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception('addResource() expects $resource to be of type Varien_Acl_Resource_Interface');
        }
        ...
        if ($this->has($resourceId)) {
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception("Resource id '$resourceId' already exists in the ACL");
        }
        ...
        if (null !== $parent) {
            try {
                if ($parent instanceof Varien_Acl_Resource_Interface) {
                    $resourceParentId = $parent->getResourceId();
                } else {
                    $resourceParentId = $parent;
                }
                $resourceParent = $this->get($resourceParentId);
            } catch (Varien_Acl_Exception $e) {
                #require_once 'Zend/Acl/Exception.php';
                throw new Varien_Acl_Exception("Parent Resource id '$resourceParentId' does not exist", 0, $e);
            }
     ...
     * @return Varien_Acl Provides a fluent interface
     */
    public function add(Varien_Acl_Resource_Interface $resource, $parent = null)
    {
     ...
     * @param  Varien_Acl_Resource_Interface|string $resource
     * @throws Varien_Acl_Exception
     * @return Varien_Acl_Resource_Interface
     */
    public function get($resource)
    {
        ...
        if (!$this->has($resource)) {
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception("Resource '$resourceId' not found");
        }
     ...
     *
     * @param  Varien_Acl_Resource_Interface|string $resource
     * @param  Varien_Acl_Resource_Interface|string $inherit
     * @param  boolean                            $onlyParent
     * @throws Varien_Acl_Resource_Registry_Exception
     * @return boolean
     */
    public function inherits($resource, $inherit, $onlyParent = false)
    {
        try {
            ...
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception($e->getMessage(), $e->getCode(), $e);
        }
     ...
     *
     * @param  Varien_Acl_Role_Interface|string|array     $roles
     * @param  Varien_Acl_Resource_Interface|string|array $resources
     * @param  string|array                             $privileges
     * @param  Varien_Acl_Assert_Interface                $assert
     * @uses   Varien_Acl::setRule()
     * @return Varien_Acl Provides a fluent interface
     */
    public function allow($roles = null, $resources = null, $privileges = null, Varien_Acl_Assert_Interface $assert = null)
    {
     ...
     * @return Varien_Acl Provides a fluent interface
     */
    public function deny($roles = null, $resources = null, $privileges = null, Varien_Acl_Assert_Interface $assert = null)
    {
    ...
    public function setRule($operation, $type, $roles = null, $resources = null, $privileges = null,
                            Varien_Acl_Assert_Interface $assert = null)
    {
        // ensure that the rule type is valid; normalize input to uppercase
        $type = strtoupper($type);
        if (self::TYPE_ALLOW !== $type && self::TYPE_DENY !== $type) {
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception("Unsupported rule type; must be either '" . self::TYPE_ALLOW . "' or '"
                                       . self::TYPE_DENY . "'");
        }
        ...
        switch ($operation) {
            ...
            default:
                #require_once 'Zend/Acl/Exception.php';
                throw new Varien_Acl_Exception("Unsupported operation; must be either '" . self::OP_ADD . "' or '"
                                           . self::OP_REMOVE . "'");
        }
     ...
     * (allow everything to all). By default, Varien_Acl creates a "whitelist" rule (deny
    ...
    public function isAllowed($role = null, $resource = null, $privilege = null)
    {
        ...
        if (null !== $role) {
            ...
            if (!$this->_isAllowedRole instanceof Varien_Acl_Role_Interface) {
                $this->_isAllowedRole = $role;
            }
        }
        ...
        if (null !== $resource) {
            ...
            if (!$this->_isAllowedResource instanceof Varien_Acl_Resource_Interface) {
                $this->_isAllowedResource = $resource;
            }
        }
     ...
     *
     * @return Varien_Acl_Role_Registry
     */
    protected function _getRoleRegistry()
    {
        if (null === $this->_roleRegistry) {
            $this->_roleRegistry = new Varien_Acl_Role_Registry();
        }
     ...
     * @return boolean|null
     */
    protected function _roleDFSAllPrivileges(Varien_Acl_Role_Interface $role, Varien_Acl_Resource_Interface $resource = null)
    {
        $dfs = array(
            'visited' => array(),
            'stack'   => array()
     ...
     * @throws Varien_Acl_Exception
     */
    protected function _roleDFSVisitAllPrivileges(Varien_Acl_Role_Interface $role, Varien_Acl_Resource_Interface $resource = null,
                                                 &$dfs = null)
    {
        if (null === $dfs) {
            /**
             * @see Varien_Acl_Exception
             */
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception('$dfs parameter may not be null');
        }
     ...
     * @throws Varien_Acl_Exception
     */
    protected function _roleDFSOnePrivilege(Varien_Acl_Role_Interface $role, Varien_Acl_Resource_Interface $resource = null,
                                            $privilege = null)
    {
        if (null === $privilege) {
            /**
             ...
             */
            #require_once 'Zend/Acl/Exception.php';
            throw new Varien_Acl_Exception('$privilege parameter may not be null');
        }
     ...
     * @throws Varien_Acl_Exception
     */
    protected function _roleDFSVisitOnePrivilege(Varien_Acl_Role_Interface $role, Varien_Acl_Resource_Interface $resource = null,
     ...
     * @return string|null
     */
    protected function _getRuleType(Varien_Acl_Resource_Interface $resource = null, Varien_Acl_Role_Interface $role = null,
                                    $privilege = null)
    {
        ...
        if ($rule['assert']) {
            ...
            $assertionValue = $assertion->assert(
                $this,
                ($this->_isAllowedRole instanceof Varien_Acl_Role_Interface) ? $this->_isAllowedRole : $role,
                ($this->_isAllowedResource instanceof Varien_Acl_Resource_Interface) ? $this->_isAllowedResource : $resource,
     ...
     * @return array|null
     */
    protected function &_getRules(Varien_Acl_Resource_Interface $resource = null, Varien_Acl_Role_Interface $role = null,
                                  $create = false)
    {
