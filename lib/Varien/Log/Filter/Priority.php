 ...
 * @version    $Id$
 */
class Varien_Log_Filter_Priority extends Varien_Log_Filter_Abstract
{
    /**
     * @var integer
     */
    ...
    public function __construct($priority, $operator = null)
    {
        if (! is_int($priority)) {
            ...
            throw new Varien_Log_Exception('Priority must be an integer');
        }
    ...
    /**
     * Create a new instance of Varien_Log_Filter_Priority
     *
     * @param  array|Varien_Config $config
     * @return Varien_Log_Filter_Priority
     */
