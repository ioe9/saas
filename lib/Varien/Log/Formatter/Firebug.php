 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Log_Formatter_Firebug extends Varien_Log_Formatter_Abstract
{
    /**
	 * Factory for Varien_Log_Formatter_Firebug classe
	 *
     * @param array|Varien_Config $options useless
	 * @return Varien_Log_Formatter_Firebug
     */
     ...
     * {@see Varien_Log_Writer_Firebug::setFormatter()} method you can
