 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Log_Writer_Syslog extends Varien_Log_Writer_Abstract
{
    /**
     * Maps Varien_Log priorities to PHP's syslog priorities
     *
     * @var array
     */
    protected $_priorities = array(
        Varien_Log::EMERG  => LOG_EMERG,
        Varien_Log::ALERT  => LOG_ALERT,
        Varien_Log::CRIT   => LOG_CRIT,
        Varien_Log::ERR    => LOG_ERR,
        Varien_Log::WARN   => LOG_WARNING,
        Varien_Log::NOTICE => LOG_NOTICE,
        Varien_Log::INFO   => LOG_INFO,
        Varien_Log::DEBUG  => LOG_DEBUG,
    );
     ...
     * @var string
     */
    protected $_application = 'Varien_Log';
    ...
    /**
     * Create a new instance of Varien_Log_Writer_Syslog
     *
     * @param  array|Varien_Config $config
     * @return Varien_Log_Writer_Syslog
     */
     ...
     * @return Varien_Log_Writer_Syslog
     * @throws Varien_Log_Exception for invalid log facility
     */
    public function setFacility($facility)
    {
        ...
        if (!in_array($facility, $this->_validFacilities)) {
            ...
            throw new Varien_Log_Exception('Invalid log facility provided; please see http://php.net/openlog for a list of valid facility values');
        }
        ...
        if ('WIN' == strtoupper(substr(PHP_OS, 0, 3))
            ...
            #require_once 'Varien/Log/Exception.php';
            throw new Varien_Log_Exception('Only LOG_USER is a valid log facility on Windows');
        }
    ...
    protected function _write($event)
    {
        ...
        if ($this->_formatter instanceof Varien_Log_Formatter_Interface) {
