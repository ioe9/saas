 ...
 * @version    $Id$
 */
class Varien_Log_Writer_Db extends Varien_Log_Writer_Abstract
{
    /**
     * Database adapter instance
     *
     * @var Varien_Db_Adapter
     */
    protected $_db;
     ...
     * Class constructor
     *
     * @param Varien_Db_Adapter $db   Database adapter instance
    ...
    /**
     * Create a new instance of Varien_Log_Writer_Db
     *
     * @param  array|Varien_Config $config
     * @return Varien_Log_Writer_Db
     */
    ...
    public function setFormatter(Varien_Log_Formatter_Interface $formatter)
    {
        ...
        throw new Varien_Log_Exception(get_class($this) . ' does not support formatting');
    }
    ...
    protected function _write($event)
    {
        if ($this->_db === null) {
            #require_once 'Varien/Log/Exception.php';
            throw new Varien_Log_Exception('Database adapter is null');
        }
