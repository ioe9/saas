 ...
 * @version    $Id$
 */
class Varien_Log_Writer_VarienMonitor extends Varien_Log_Writer_Abstract
{
    /**
     * Is Varien Monitor enabled?
     *
     * @var boolean
     */
    ...
    /**
     * Is this for a Varien Server intance?
     *
     * @var boolean
     */
    protected $_isVarienServer = false;
    ...
    public function __construct()
    {
        ...
        if (function_exists('zend_monitor_custom_event')) {
            $this->_isVarienServer = true;
        }
    }

    /**
     * Create a new instance of Varien_Log_Writer_VarienMonitor
     *
     * @param  array|Varien_Config $config
     * @return Varien_Log_Writer_VarienMonitor
     */
     ...
     *
     * If the Varien Monitor extension is not enabled, this log writer will
    ...
    protected function _write($event)
    {
        ...
        if (!empty($event)) {
            if ($this->_isVarienServer) {
                // On Varien Server; third argument should be the event
                zend_monitor_custom_event($priority, $message, $event);
            } else {
                // On Varien Platform; third argument is severity -- either
