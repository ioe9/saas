 ...
 */
class Varien_Http_Adapter_Curl implements Varien_Http_Client_Adapter_Interface
{
    /**
     * Parameters array
     *
     ...
     *
     * @param string        $method
     * @param string|Varien_Uri_Http $url
    ...
    {
        if ($url instanceof Varien_Uri_Http) {
            $url = $url->getUri();
        }
        $this->_applyConfig();
        ...
        } elseif ($method == Varien_Http_Client::GET) {
    ...
    public function read()
    {
        ...
        while (Varien_Http_Response::extractCode($response) == 100 || Varien_Http_Response::extractCode($response) == 101) {
