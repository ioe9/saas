...
#require_once 'Varien/Http/UserAgent/AbstractDevice.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Http_UserAgent_Mobile extends Varien_Http_UserAgent_AbstractDevice
{

    const DEFAULT_FEATURES_ADAPTER_CLASSNAME = 'Varien_Http_UserAgent_Features_Adapter_Browscap';

    const DEFAULT_FEATURES_ADAPTER_PATH = 'Varien/Http/UserAgent/Features/Adapter/Browscap.php';
