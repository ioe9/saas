 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Http_UserAgent_Features_Adapter_Browscap
    implements Varien_Http_UserAgent_Features_Adapter
{
    /**
     * Constructor
     *
     ...
     *
     * @throws Varien_Http_UserAgent_Features_Exception
     */
    public function __construct()
    {
        ...
        if (empty($browscap) || !file_exists($browscap)) {
            ...
            throw new Varien_Http_UserAgent_Features_Exception(sprintf(
