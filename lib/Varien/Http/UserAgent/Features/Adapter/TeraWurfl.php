 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Http_UserAgent_Features_Adapter_TeraWurfl implements Varien_Http_UserAgent_Features_Adapter
{
    /**
    ...
    public static function getFromRequest($request, array $config)
    {
        if (!class_exists('TeraWurfl')) {
            ...
            if (!isset($config['terawurfl'])) {
                ...
                throw new Varien_Http_UserAgent_Features_Exception('"TeraWurfl" configuration is not defined');
            }
            ...
            $config = $config['terawurfl'];
             ...
             if (empty($config['terawurfl_lib_dir'])) {
                // No lib_dir given
                #require_once 'Varien/Http/UserAgent/Features/Exception.php';
                throw new Varien_Http_UserAgent_Features_Exception('The "terawurfl_lib_dir" parameter is not defined');
            }
