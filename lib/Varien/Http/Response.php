...
/**
 * Varien_Http_Response represents an HTTP 1.0 / 1.1 response message. It
...
class Varien_Http_Response
{
     ...
     *
     * In most cases, you would use Varien_Http_Response::fromString to parse an HTTP
     * response string and create a new Varien_Http_Response object.
     *
    ...
    public function __construct($code, array $headers, $body = null, $version = '1.1', $message = null)
    {
        ...
        if (self::responseCodeAsText($code) === null) {
            ...
            throw new Varien_Http_Exception("{$code} is not a valid HTTP response code");
        }
        ...
        foreach ($headers as $name => $value) {
            if (is_int($name)) {
                ...
                if (count($header) != 2) {
                    #require_once 'Varien/Http/Exception.php';
                    throw new Varien_Http_Exception("'{$value}' is not a valid HTTP header");
                }
        ...
        if (! preg_match('|^\d\.\d$|', $version)) {
            #require_once 'Varien/Http/Exception.php';
            throw new Varien_Http_Exception("Invalid HTTP response version: $version");
        }
    ...
    public static function extractHeaders($response_str)
    {
        ...
        foreach($lines as $index => $line) {
            ...
            if (preg_match("|^([a-zA-Z0-9\'`#$%&*+.^_\|\~!-]+):\s*(.*)|s", $line, $m)) {
                ...
                $h_value = $m[2];
                Varien_Http_Header_HeaderValue::assertValid($h_value);
            ...
            #require_once 'Varien/Http/Exception.php';
            throw new Varien_Http_Exception('Invalid header line detected');
        }
    ...
    public static function decodeChunkedBody($body)
    {
        ...
        while (trim($body)) {
            if (! preg_match("/^([\da-fA-F]+)[^\r\n]*\r\n/sm", $body, $m)) {
                #require_once 'Varien/Http/Exception.php';
                throw new Varien_Http_Exception("Error parsing body - doesn't seem to be a chunked message");
            }
    ...
    public static function decodeGzip($body)
    {
        if (! function_exists('gzinflate')) {
            #require_once 'Varien/Http/Exception.php';
            throw new Varien_Http_Exception(
    ...
    /**
     * Create a new Varien_Http_Response object from a string
     *
     * @param string $response_str
    ...
    public static function fromString($response_str)
    {
        ...
        return new Varien_Http_Response($code, $headers, $body, $version, $message);
    }
}
