...
/**
 * @see Varien_Http_Client
 */
#require_once 'Varien/Http/Client.php';
/**
 * @see Varien_Http_Client_Adapter_Socket
 */
#require_once 'Varien/Http/Client/Adapter/Socket.php';

/**
 * HTTP Proxy-supporting Varien_Http_Client adapter class, based on the default
 * socket based adapter.
 *
 * Should be used if proxy HTTP access is required. If no proxy is set, will
 * fall back to Varien_Http_Client_Adapter_Socket behavior. Just like the
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Varien_Http_Client_Adapter_Proxy extends Varien_Http_Client_Adapter_Socket
{
    /**
     * Parameters array
     *
    ...
    protected $config = array(
        ...
        'proxy_user'    => '',
        'proxy_pass'    => '',
        'proxy_auth'    => Varien_Http_Client::AUTH_BASIC,
        'persistent'    => false,
    );
        ...
        if ($this->config['proxy_user']) {
            ...
            if (!$hasProxyAuthHeader) {
                $headers[] = 'Proxy-authorization: '
                    . Varien_Http_Client::encodeAuthHeader(
    ...
    )
    {
        ...
        if (Varien_Http_Response::extractCode($response) != 200) {
            #require_once 'Varien/Http/Client/Adapter/Exception.php';
            throw new Varien_Http_Client_Adapter_Exception(
