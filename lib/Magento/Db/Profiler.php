...
class Magento_Db_Profiler
{
    ...
    public function queryEnd($queryId)
    {
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
            ...
            throw new Varien_Db_Exception("Profiler has no query with handle '$queryId'.");
        }
        ...
        if ($qp->hasEnded()) {
             ...
             */
            #require_once 'Zend/Db/Profiler/Exception.php';
            throw new Varien_Db_Exception("Query with profiler handle '$queryId' has already ended.");
        }
    ...
    public function getQueryProfile($queryId)
    {
        if (!array_key_exists($queryId, $this->_queryProfiles)) {
             ...
             */
            #require_once 'Zend/Db/Profiler/Exception.php';
            throw new Varien_Db_Exception("Query handle '$queryId' not found in profiler log.");
        }
