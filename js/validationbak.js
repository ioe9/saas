...
*
*/
function Validator(className, error, test, options){
...
Validation.prototype = {
    initialize : function(form, options){
        ...
        if(this.options.onSubmit) this.form.bind('submit',this.onSubmit.bind(this),false);
    ...
    validate : function() {
        ...
        try {
        	...
        	$.each(values,function(index,value){
			    //自带验证TODO...
			    return Validation.validate($(values[index]),{useTitle : useTitles, onElementValidate : callback});
			});
        } catch (e) {
        	console.log(e);
        }
