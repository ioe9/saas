    ...
    initGrid : function(){
        ...
        if($(this.containerId+this.tableSufix)){
            ...
            this.rows.each(function(row,e){
                ...
                $(e).bind('mouseover',mioGrid.trOnMouseOver);
                $(e).bind('mouseout',mioGrid.trOnMouseOut);
                $(e).bind('click',mioGrid.trOnClick);
                $(e).bind('dblclick',mioGrid.trOnDblClick);
        ...
        if(this.sortVar && this.dirVar){
            ...
            columns.each(function(col,e){
                $(e).bind('click',this.thLinkOnClick);
            })
        }
