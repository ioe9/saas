<?php
class Mage_Approve_Block_Adminhtml_Template_Edit_Company_Advance extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $collection = Mage::getResourceModel('approve/company_attr_collection')
        ...
        if ($model->getId()) {
        	$values = Mage::getResourceModel('approve/company_attr_value_collection')
