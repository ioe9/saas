...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
    ...
    public function getCurrenCategoryKey()
    {
        if (!$this->_currentCategoryKey) {
            ...
            if ($category) {
                ...
                $this->_currentCategoryKey = Mage_Catalog_Model_Category::TREE_DEFAULT_ID;
            }
        }
    ...
    public function getCurrentChildCategories()
    {
        if (null === $this->_currentChildCategories) {
            ...
            $layer->preparePostCollection($postCollection);
            $postCollection->addCountToCategories($this->_currentChildCategories);
        }
