<?php
class Mage_Catalog_Block_Post_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Posts collection
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('catalog/post/list/toolbar.phtml');
    }
    ...
    /**
     * Return posts collection instance
     *
    ...
    /**
     * Get grit posts sort order field
     *
     * @return string
     */
     ...
     *
     * @param string $order
     * @param Mage_Catalog_Block_Post_List_Toolbar
     */
    ...
    {
        $pagerBlock = $this->getChild('post_list_toolbar_pager');
