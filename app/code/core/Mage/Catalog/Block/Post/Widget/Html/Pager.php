...
/**
 * New posts widget pager block
 *
 * @category   Mage
 * @package    Mage_Catalog
 * @author     Mio Core Team <developer@ioe9.com>
 */
class Mage_Catalog_Block_Post_Widget_Html_Pager extends Mage_Page_Block_Html_Pager
{
    /**
     * Collection size
     *
     ...
     * @return  Mage_Catalog_Block_Post_Widget_Html_Pager
     */
