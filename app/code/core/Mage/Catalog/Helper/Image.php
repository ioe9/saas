...
{
    const XML_NODE_PRODUCT_BASE_IMAGE_WIDTH = 'catalog/post_image/base_width';
    const XML_NODE_PRODUCT_SMALL_IMAGE_WIDTH = 'catalog/post_image/small_width';

    /**
     * Current model
     *
     * @var Mage_Catalog_Model_Post_Image
     */
    protected $_model;
     ...
     * @return Mage_Catalog_Helper_Image
     */
    public function init(Mage_Catalog_Model_Post $post, $name, $imageFile=null)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('catalog/post_image'));
        $this->_getModel()->setDestinationSubdir($name);
        $this->setPost($post);
     ...
     *
     * @see Mage_Catalog_Model_Post_Image
     * @param int $width
     * @param int $height
     * @return Mage_Catalog_Helper_Image
     */
    ...
    public function getPlaceholder()
    {
        if (!$this->_placeholder) {
            ...
            $this->_placeholder = 'images/catalog/post/placeholder/'.$attr.'.jpg';
        }
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getPost()->getData($model->getDestinationSubdir()));
            }
     ...
     *
     * @param Mage_Catalog_Model_Post_Image $model
     * @return Mage_Catalog_Helper_Image
     */
     ...
     *
     * @return Mage_Catalog_Model_Post_Image
     */
