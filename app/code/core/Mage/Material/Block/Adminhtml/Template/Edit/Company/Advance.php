<?php
class Mage_Material_Block_Adminhtml_Template_Edit_Company_Advance extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $collection = Mage::getResourceModel('material/company_attr_collection')
        ...
        if ($model->getId()) {
        	$values = Mage::getResourceModel('material/company_attr_value_collection')
