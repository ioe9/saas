<?php
class Mage_Edm_Block_Adminhtml_Template_Edit_Company_Advance extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $collection = Mage::getResourceModel('edm/company_attr_collection')
