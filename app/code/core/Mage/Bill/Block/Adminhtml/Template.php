<?php
class Mage_Bill_Block_Adminhtml_Template extends Mage_Adminhtml_Block_Template
{
	protected $_pageSize = 20;
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('bill/template.phtml');
    }
    ...
    protected function _prepareLayout(){
        ...
        $collection = Mage::getModel('bill/template')->getCollection();
        if ($tag) {
        	$tagModel = Mage::getModel('bill/template_tag')->loadByName($tag);
        	if ($tagModel->getId()) {
        		$collection->getSelect()
        			->join(array('r'=>'bill_template_tag_relate'),
        ...
        if ($categoryId) {
    		...
    		$collection->getSelect()
        			->join(array('r'=>'bill_template_category_relate'),
        ...
        $pager = $this->getLayout()->createBlock('page/html_pager')
                ->setTemplate('bill/html/pager.phtml')
