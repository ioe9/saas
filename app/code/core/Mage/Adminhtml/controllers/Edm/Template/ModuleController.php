<?php
class Mage_Adminhtml_Edm_Template_ModuleController extends Mage_Adminhtml_Controller_Edm
{
	...
	public function indexAction() {
        ...
        $this->_addContent($this->getLayout()->createBlock('edm/adminhtml_template_module', 'template.module'));
		$this->renderLayout();
	}
	public function configsysAction() {
		$this->loadLayout();
		$this->_setActiveMenu('template');
		$id = $this->getRequest()->getParam('id');
		Mage::register('current_module',Mage::getModel('edm/templates_module')->load($id));
        $this->_addContent($this->getLayout()->createBlock('edm/adminhtml_template_module_item', 'template.module.item'));
		$this->renderLayout();
	}
	public function configAction() {
		...
		$id = $this->getRequest()->getParam('id');
		Mage::register('current_module',Mage::getModel('edm/templates_module')->load($id));
		Mage::register('use_my_filter',true);
        $this->_addContent($this->getLayout()->createBlock('edm/adminhtml_template_module_item', 'template.module.item'));
		$this->renderLayout();
	}
