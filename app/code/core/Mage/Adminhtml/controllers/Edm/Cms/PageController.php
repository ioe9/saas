 ...
 */
class Mage_Adminhtml_Edm_Cms_PageController extends Mage_Adminhtml_Controller_Edm
{

    /**
     * Init actions
     *
     * @return Mage_Adminhtml_Edm_Cms_PageController
     */
    ...
    public function indexAction()
    {
        ...
        $this->_initAction();
        //echo "<xmp>";var_dump($this->getLayout());die();
        $this->renderLayout();
    }
    ...
    protected function _validatePostData($data)
    {
        ...
        if (!empty($data['layout_update_xml']) || !empty($data['custom_layout_update_xml'])) {
            /** @var $validatorCustomLayout Mage_Adminhtml_Edm_Model_LayoutUpdate_Validator */
