 ...
 */
class Mage_Adminhtml_Edm_Cms_Wysiwyg_ImagesController extends Mage_Adminhtml_Controller_Edm
{
    /**
     * Init storage
     *
     * @return Mage_Adminhtml_Edm_Cms_Page_Wysiwyg_ImagesController
     */
