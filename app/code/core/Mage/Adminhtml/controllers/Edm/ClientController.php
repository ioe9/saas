<?php
class Mage_Adminhtml_Edm_ClientController extends Mage_Adminhtml_Controller_Edm {
	public function indexAction() {
		$this->loadLayout();
		$this->_setActiveMenu('client/list');
		$this->_title("客户管理")->_title("客户列表");
		$this->_addContent($this->getLayout()->createBlock('edm/adminhtml_client', 'client'));
		$this->renderLayout();
	}
