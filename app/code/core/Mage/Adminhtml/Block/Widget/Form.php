...
class Mage_Adminhtml_Block_Widget_Form extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
		...
		Varien_Data_Form::setFieldgroupRenderer(
            $this->getLayout()->createBlock('adminhtml/widget_form_renderer_fieldgroup')
        );
        Varien_Data_Form::setFieldgroupElementRenderer(
            $this->getLayout()->createBlock('adminhtml/widget_form_renderer_fieldgroup_element')
        );
        Varien_Data_Form::setTrRenderer(
            $this->getLayout()->createBlock('adminhtml/widget_form_renderer_tr')
        );
        Varien_Data_Form::setTrElementRenderer(
            $this->getLayout()->createBlock('adminhtml/widget_form_renderer_tr_element')
        );
