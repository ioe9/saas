<?php
class Mage_Adminhtml_Block_Page_Navigation extends Mage_Adminhtml_Block_Template
{
    const CACHE_TAGS = 'BACKEND_NAVIGATION';
    ...
    {
        parent::_construct();
        $this->setTemplate('page/navigation.phtml');
