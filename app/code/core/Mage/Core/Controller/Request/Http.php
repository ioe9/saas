<?php
class Mage_Core_Controller_Request_Http extends Varien_Controller_Request_Http
{
    ...
    {
        $request = new Varien_Controller_Request_Http();
    ...
    public function getHttpHost($trimPort = true)
    {
        ...
        if (strpos($host, ',') !== false || strpos($host, ';') !== false) {
            $response = new Varien_Controller_Response_Http();
