...
class Mage_Core_Controller_Varien_Front extends Varien_Object
{
    ...
    const XML_ROUTERS_PATH = 'default/routers';
    ...
    public function init()
    {
        ...
        $routersInfo = Mage::getStoreConfig(self::XML_ROUTERS_PATH);
    ...
    public function dispatch()
    {
        ...
        $i = 0;
        //echo "<xmp>";var_dump($this->_routers);die();
        ...
        //echo "<xmp>";var_dump($this->getResponse());die(); //Mage_Core_Controller_Response_Http
        $this->getResponse()->sendResponse();
        //echo 'sendResponse'; //已经到这里
    ...
    protected function _getRequestRewriteController()
    {
		...
		//core/url_rewrite
		//var_dump($className); //@gary
		$className = 'core/url_rewrite';
