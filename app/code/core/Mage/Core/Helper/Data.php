...
XML;
    ...
    {
        $json = Varien_Json::encode($valueToEncode, $cycleCheck, $options);
     ...
     * @return mixed
     */
    public function jsonDecode($encodedValue, $objectDecodeType = Varien_Json::TYPE_ARRAY)
    {
        return Varien_Json::decode($encodedValue, $objectDecodeType);
    }
