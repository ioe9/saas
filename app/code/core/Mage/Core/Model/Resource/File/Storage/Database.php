...
class Mage_Core_Model_Resource_File_Storage_Database extends Mage_Core_Model_Resource_File_Storage_Abstract
{
    ...
    public function renameFile($oldFilename, $oldPath, $newFilename, $newPath)
    {
        ...
        $dataWhere[] = new Magento_Db_Expr($adapter->prepareSqlCondition('directory', array('seq' => $oldPath)));
    ...
    public function deleteFolder($folderName = '')
    {
        ...
        $this->_getWriteAdapter()
            ->delete($this->getMainTable(), new Magento_Db_Expr('directory LIKE ' . $likeExpression));
    }
    ...
    public function deleteFile($filename, $directory)
    {
        ...
        $where[] = new Magento_Db_Expr($adapter->prepareSqlCondition('directory', array('seq' => $directory)));
