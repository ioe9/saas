<?php
class Mage_Report_Block_Adminhtml_Report_Reply_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
		...
		$data = array('reply_report'=>$report->getId());
        ...
        $fieldset->addField('reply_report', 'hidden', array(
            'name'      => 'reply_report',
        ));
