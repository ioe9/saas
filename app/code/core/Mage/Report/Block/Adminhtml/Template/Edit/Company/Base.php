<?php
class Mage_Report_Block_Adminhtml_Template_Edit_Company_Base extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('category_a', 'multiselect', array(
            ...
            'label'     => '邮件模板大类',
            'title'     => '邮件模板大类',
            'values'      => Mage::getModel('report/template_category')->getCategoriesMulitiOption(1,true),
            'required'  => false,
            'size'  => '5',
            'style' => 'height:100px'
        ...
        if ($model) {
        	$cats = Mage::getResourceModel('report/company_category_collection')
		...
		$fieldset->addField('category_b', 'multiselect', array(
            ...
            'label'     => '邮件模板二级类别',
            'title'     => '邮件模板二级类别',
            'values'    => Mage::getModel('report/template_category')->getSecondMulitiOption(),
            'required'  => false,
            'size'  => '5',
            'style' => 'height:100px'
        ));
