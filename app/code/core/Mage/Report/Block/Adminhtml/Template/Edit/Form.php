<?php
class Mage_Report_Block_Adminhtml_Template_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('category_id', 'select', array(
            ...
            'title'     => '所属分类',
            'required'  => false,
            'options'   => Mage::getModel('report/template_category')->getCategoriesOption(),
        ));
