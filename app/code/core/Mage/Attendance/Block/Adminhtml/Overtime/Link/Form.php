<?php
class Mage_Attendance_Block_Adminhtml_Overtime_Link_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
		...
		$overtime = Mage::registry('current_overtime');
		$data = array('link_object'=>$overtime->getId());
        ...
        $fieldset->addField('overtime_submit', 'button', array(
            'name'      => 'overtime_submit',
            'label'     => '',
            'title'     => '',
