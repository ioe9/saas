<?php
class Mage_Attendance_Block_Adminhtml_Travel_Link_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
		...
		$travel = Mage::registry('current_travel');
		$data = array('link_object'=>$travel->getId());
        ...
        $fieldset->addField('travel_submit', 'button', array(
            'name'      => 'travel_submit',
            'label'     => '',
            'title'     => '',
